...
import { TypeWishListItemModel, TypeWishListModel } from "@/types/models";
...
export default function Checkout({
  ...
  >
    {wishlist && (
      <div className="flex flex-col gap-4 pb-4">
        ...
        <div className="flex flex-col gap-1">
          {wishlist.WishListItems.length > 0 &&
            wishlist.WishListItems.map((item: TypeWishListItemModel, idx) => (
      ...
      {/*
        ...
        <div className="flex justify-between">
          <div className="flex">
            <span>
              <FormattedMessage id="wishlist.shipping" defaultMessage="Shipping" />
            </span>
    ...
    {/* <div className="flex justify-between">
      <div className="flex">
        <span>
          <FormattedMessage id="wishlist.discount" defaultMessage="Discount" />
        </span>
    ...
    {/* <div className="flex justify-between">
      <div className="flex">
        <span>
          <FormattedMessage id="wishlist.tax" defaultMessage="Tax (TVQ+TPS)" />
        </span>
