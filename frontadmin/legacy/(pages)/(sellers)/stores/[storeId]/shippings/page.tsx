...
import Shippings from "@/components/modules/sellers/stores/shippings";
...
export default async function page({
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-wrap space-y-4 justify-between items-center">
              ...
              <div className="flex items-center gap-1 ">
                <Link
                  href={`/stores/${params.storeId}/shippings/new`}
      ...
      <section>
        <Container>
          <Shippings store={params.storeId} />
        </Container>
      </section>
    </>
  );
...
export const metadata: Metadata = {
  title: "Shippings - E-City - Ecommerce",
  description:
